...
class ProductosModelForm(ModelForm):
    ...
    class Meta:
        ...
        model = Productos
        #fields = "__all__"
        fields = ['nombre','descripcion','cantidad','tipo','marca']
        widgets = {
            "nombre": forms.TextInput(attrs={'placeholder': 'Ingrese Nombre','class':'form-control'}),
            "descripcion": forms.TextInput(attrs={'placeholder': 'Ingrese Nombre del RUT','class':'form-control'}),
            "cantidad": forms.NumberInput(attrs={'placeholder': 'Ingrese Cantidad','class':'form-control','style':''}),
            "tipo": forms.TextInput(attrs={'placeholder': 'Ingrese Tipo','class':'form-control'}),
            "marca": forms.TextInput(attrs={'placeholder': 'Ingrese Marca','class':'form-control'}),
