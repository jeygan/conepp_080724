...
from aplicaciones.trabajadores.form import TrabajadoresModelForm

# Create your views here.


# update view for details@login_required
def trabajador_update(request, **kwargs):
    ...
    if request.POST and form.is_valid():
        ...
        print("Probando save")
        form.save()
        return redirect('profesores:listaProfesores')
    
    #Pasamos aqui cuando es GET
    return render(request, 'profesores/editar-profesor.html', context)

#Esta vista es para que no se envien 2 registros de usuarios
def trabajador_cuenta_creada(request):
